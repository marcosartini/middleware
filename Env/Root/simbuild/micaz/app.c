...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f083adfd840, const void *arg_0x7f083adfdb40);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f083ad745e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f083ab18d50), 
int (*key_eq_fn)(void *arg_0x7f083ab17550, void *arg_0x7f083ab17810));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f083a9043f0, int arg_0x7f083a904670);
static double RandomUniform(void );
...
typedef TMilli EnvRootC$Timer$precision_tag;
...
static void EnvRootC$Boot$booted(void );
# 110 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void EnvRootC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void EnvRootC$RadioControl$startDone(error_t error);
#line 138
static void EnvRootC$RadioControl$stopDone(error_t error);
...
static void EnvRootC$Timer$fired(void );
...
# 80 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 80 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t EnvRootC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 104 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static error_t EnvRootC$RadioControl$start(void );
# 88 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static am_addr_t EnvRootC$AMPacket$source(
#line 84
message_t * amsg);
# 64 "/home/marco/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void EnvRootC$Timer$startPeriodic(uint32_t dt);
# 24 "EnvRootC.nc"
uint32_t EnvRootC$counter[1000];
message_t EnvRootC$pkt[1000];
bool EnvRootC$busy[1000];

static inline void EnvRootC$Boot$booted(void );




static inline void EnvRootC$RadioControl$startDone(error_t error);
...
static inline void EnvRootC$RadioControl$stopDone(error_t error);

static inline void EnvRootC$Timer$fired(void );
#line 63
static inline message_t *EnvRootC$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 85
static inline void EnvRootC$AMSend$sendDone(message_t *msg, error_t err);
# 62 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Init.nc"
...
# 110 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
...
# 88 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static am_addr_t EnvRootC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 63
{
  ...
  if (len == sizeof(AvgMsg )) {
      ...
      sourceAddr = EnvRootC$AMPacket$source(msg);
      avgH = __nesc_ntoh_uint8(avgpkt->humidity.nxdata);
      avgT = __nesc_ntoh_uint8(avgpkt->temperature.nxdata);
      local_id = __nesc_ntoh_uint32(avgpkt->local_id.nxdata);
      sim_log_debug(47U, "default", "%s | Received from %d, avgH = %d, avgT = %d (local_id=%d)\n", sim_time_string(), sourceAddr, avgH, avgT, local_id);
    }
...
# 78 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7f083a4a9650, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f083a4a9650) {
#line 78
    case 231:
#line 78
      __nesc_result = EnvRootC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7f083a4a9650, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7f083a4a8280, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7f083a4a8280, msg, payload, len);
#line 78
...
# 64 "/home/marco/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void EnvRootC$Timer$startPeriodic(uint32_t dt){
#line 64
  ...
  if (error == SUCCESS) 
    {
      ...
      EnvRootC$Timer$startPeriodic(TMILLI_PERIOD);
    }
}
...
#line 113
  EnvRootC$RadioControl$startDone(error);
#line 113
  EnvRootC$RadioControl$startDone(error);
#line 113
}
...
#line 138
  EnvRootC$RadioControl$stopDone(error);
#line 138
  EnvRootC$RadioControl$stopDone(error);
#line 138
}
...
# 110 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7f083a4aa450, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7f083a4aa450, msg, error);
#line 110
}
#line 110
...
#line 85
{
  if (&EnvRootC$pkt[sim_node()] == msg) {
#line 86
    EnvRootC$busy[sim_node()] = FALSE;
    }
}

# 110 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  EnvRootC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7f083a006de0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f083a006de0) {
#line 100
    case 0U:
#line 100
      /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7f083a006de0, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7f083a7ef020){
#line 75
  switch (arg_0x7f083a7ef020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7f083a7ef020);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7f083a0030d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7f083a0030d0, addr, msg, len);
#line 80
...
# 75 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 231);
  return /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t EnvRootC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*EnvRootAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Packet.nc"
inline static void * EnvRootC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 44
{
  EnvRootC$counter[sim_node()]++;
  if (!EnvRootC$busy[sim_node()]) {
      CollectMsg *cmpkt = 
      (CollectMsg *)EnvRootC$Packet$getPayload(&EnvRootC$pkt[sim_node()], sizeof(CollectMsg ));
...
#line 50
      ...
      __nesc_hton_uint32(cmpkt->msg_id.nxdata, EnvRootC$counter[sim_node()]);


      if (
#line 53
      EnvRootC$AMSend$send(AM_BROADCAST_ADDR, 
      &EnvRootC$pkt[sim_node()], sizeof(CollectMsg )) == SUCCESS) {
          EnvRootC$busy[sim_node()] = TRUE;
          sim_log_debug(46U, "default", "%s | Sent collect message with id=%d from %d\n", sim_time_string(), EnvRootC$counter[sim_node()], TOS_NODE_ID);
        }
    }
}
...
# 83 "/home/marco/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7f083a0a1950){
#line 83
  switch (arg_0x7f083a0a1950) {
#line 83
    case 0U:
#line 83
      EnvRootC$Timer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7f083a0a1950);
#line 83
      break;
#line 83
    }
...
#line 62
# 104 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static error_t EnvRootC$RadioControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
  __nesc_result = ecombine(__nesc_result, TossimPacketModelC$Control$start());
#line 104
...
static inline void EnvRootC$Boot$booted(void )
{
  EnvRootC$RadioControl$start();
}

# 60 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  EnvRootC$Boot$booted();
#line 60
}
#line 60
# 67 "/home/marco/tinyos-release-tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
...
{
  /* Module EnvRootC */
  if (!strcmp(varname, "EnvRootC$counter"))
  {
    *addr = (uintptr_t)&EnvRootC$counter[__nesc_mote];
    *size = sizeof(EnvRootC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EnvRootC$pkt"))
  {
    *addr = (uintptr_t)&EnvRootC$pkt[__nesc_mote];
    *size = sizeof(EnvRootC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EnvRootC$busy"))
  {
    *addr = (uintptr_t)&EnvRootC$busy[__nesc_mote];
    *size = sizeof(EnvRootC$busy[__nesc_mote]);
    return 0;
  }
...
{
  /* Module EnvRootC */
  EnvRootC$counter[__nesc_mote] = 0;
  memset((void *)&EnvRootC$pkt[__nesc_mote], 0, sizeof EnvRootC$pkt[__nesc_mote]);
  EnvRootC$busy[__nesc_mote] = FALSE;
